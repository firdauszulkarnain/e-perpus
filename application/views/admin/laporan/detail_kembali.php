            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="no_transaksi" name="no_transaksi" value="<?= $pengembalian['nomor_transaksi'] ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="buku" name="buku" value="<?= $pengembalian['judul_buku'] ?>" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="anggota_peminjam" value="<?= $pengembalian['nama_lengkap'] ?>" name="anggota_peminjam" readonly>
                            </div>
                        </div>
                        <div class="col-lg-2 mt-3">
                            <!-- Button Detail -->
                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="tanggal_pinjam" name="tanggal_pinjam" value="<?= $pengembalian['tanggal_pinjam'] ?>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="tenggat">Tenggat Penggembalian</label>
                            <input type="text" class="form-control" id="tenggat" name="tenggat" value="<?= $pengembalian['tanggal_kembali'] ?>" readonly>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label for="tanggal_kembali">Tanggal Pengembalian</label>
                                <input type="text" class="form-control" id="tanggal_kembali" name="tanggal_kembali" value="<?= $pengembalian['tgl_kembali'] ?>" readonly>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="total">Total</label>
                                <input type="text" class="form-control" id="total" name="total" readonly value="<?= $pengembalian['subtotal'] ?>">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="denda">Denda</label>
                                <input type="text" class="form-control" id="denda" name="denda" readonly value="<?= $pengembalian['denda'] ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control font-weight-bolder" id="exampleFormControlTextarea1" rows="1" readonly style="text-align: right !important; font-size: 28px;"><?= number_format($pengembalian['total_bayar'], 0, ',', '.'); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
